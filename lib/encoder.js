/* jshint esversion:6 */
/*
This library file has be borrowed from the graphicore/librebarcode repo for the
purpose of converting provided UPCs sans-check-digit into Code 128 barcodes with
check digit.
*/
var data = [
